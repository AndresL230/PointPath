  ...
  return (
    <main className="bg-custom-blue min-h-screen mx-17 mt-8 mb-10">
      ...
      <section className="relative">
        <button
          onClick={() => setShowCardRecommendation(!showCardRecommendation)}
            ...
            <form className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-1/4 px-4 py-2 border text-gray-600 text-sm border-slate-300 rounded-lg focus:outline-none"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-1/4 pl-8 pr-4 py-2 border text-gray-600 text-sm border-slate-300 rounded-lg focus:outline-none"
                  />
                </div>
              </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex gap-3">
                    <div className="w-full flex flex-col gap-3">
                      ...
                      <button
                        type="button"
                        className="px-4 py-2 bg-black w-1/8 text-white rounded-lg hover:bg-gray-800"
                      >
                        No
                      </button>
                    </div>
